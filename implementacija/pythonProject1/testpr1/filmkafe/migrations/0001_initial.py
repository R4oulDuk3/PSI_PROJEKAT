# Generated by Django 3.2.13 on 2022-05-26 23:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(db_column='Type', default='Popust', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('akcija', models.CharField(blank=True, db_column='Akcija', max_length=4, null=True)),
            ],
            options={
                'db_table': 'meni',
                'ordering': ('subtype',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weighter', models.ForeignKey(db_column='Weighter', on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'schedule',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productbought', models.ForeignKey(db_column='ProductBought', on_delete=django.db.models.deletion.DO_NOTHING, to='filmkafe.product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'db_table': 'preference',
                'managed': True,
                'unique_together': {('preferedshift', 'day')},
            },
        ),
        migrations.CreateModel(
            name='EventTable',
